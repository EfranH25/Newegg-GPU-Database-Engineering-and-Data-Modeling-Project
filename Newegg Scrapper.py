...
if __name__ == '__main__':
    ...
    print('Enter URL (NOTE: Make sure page is at the very end of the URL without a number to the page traversal to work properly)')
    ...
    master_df.to_csv('products_'+GPU_model + '.csv')
    print('done')